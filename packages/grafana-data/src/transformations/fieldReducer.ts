...
export const fieldReducers = new Registry<FieldReducerInfo>(() => [
  {
    ...
    name: 'Last *',
    description: 'Последнее ненулевое значение',
    standard: true,
    aliasIds: ['current'],
  ...
  { id: ReducerID.min, name: 'Min', description: 'Минимальное значение', standard: true, preservesUnits: true },
  { id: ReducerID.max, name: 'Max', description: 'Максимальное значение', standard: true, preservesUnits: true },
  {
    id: ReducerID.mean,
    name: 'Avg',
  ...
  },
  {
    id: ReducerID.range,
    name: 'Range',
    description: 'Разница между минимальным и максимальным значениями',
    standard: true,
    preservesUnits: true,
  },
  {
